...
export const api_v1_pet_listSucceeded = response => ({
  type: types.API_V1_PET_LIST_SUCCEEDED,
  response
})
export const api_v1_pet_listFailed = error => ({
  type: types.API_V1_PET_LIST_FAILED,
  error
})
export const api_v1_pet_create = () => ({ type: types.API_V1_PET_CREATE })
export const api_v1_pet_createSucceeded = response => ({
  type: types.API_V1_PET_CREATE_SUCCEEDED,
  response
})
export const api_v1_pet_createFailed = error => ({
  type: types.API_V1_PET_CREATE_FAILED,
  error
})
export const api_v1_pet_read = () => ({ type: types.API_V1_PET_READ })
export const api_v1_pet_readSucceeded = response => ({
  type: types.API_V1_PET_READ_SUCCEEDED,
  response
})
export const api_v1_pet_readFailed = error => ({
  type: types.API_V1_PET_READ_FAILED,
  error
})
export const api_v1_pet_update = () => ({ type: types.API_V1_PET_UPDATE })
export const api_v1_pet_updateSucceeded = response => ({
  type: types.API_V1_PET_UPDATE_SUCCEEDED,
  response
})
export const api_v1_pet_updateFailed = error => ({
  type: types.API_V1_PET_UPDATE_FAILED,
  error
})
export const api_v1_pet_partial_update = () => ({
  type: types.API_V1_PET_PARTIAL_UPDATE
})
export const api_v1_pet_partial_updateSucceeded = response => ({
  type: types.API_V1_PET_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_pet_partial_updateFailed = error => ({
  type: types.API_V1_PET_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_pet_delete = () => ({ type: types.API_V1_PET_DELETE })
export const api_v1_pet_deleteSucceeded = response => ({
  type: types.API_V1_PET_DELETE_SUCCEEDED,
  response
})
export const api_v1_pet_deleteFailed = error => ({
