...
function* api_v1_pet_listWorker(action) {
  try {
    ...
    yield put(actions.api_v1_pet_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_pet_listFailed(err))
  }
}
...
function* api_v1_pet_createWorker(action) {
  try {
    ...
    yield put(actions.api_v1_pet_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_pet_createFailed(err))
  }
}
...
function* api_v1_pet_readWorker(action) {
  try {
    ...
    yield put(actions.api_v1_pet_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_pet_readFailed(err))
  }
}
...
function* api_v1_pet_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_pet_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_pet_updateFailed(err))
  }
}
...
function* api_v1_pet_partial_updateWorker(action) {
  try {
    ...
    yield put(actions.api_v1_pet_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_pet_partial_updateFailed(err))
  }
}
...
function* api_v1_pet_deleteWorker(action) {
  try {
    ...
    yield put(actions.api_v1_pet_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_pet_deleteFailed(err))
  }
}
